...
<head>
	...
	<link href="<?php echo get_theme_root_uri(); ?>/Priceless/style.css" rel="stylesheet">
...
<body>
	...
	<section class="topo">
		<div class="center">
			<header>
				<div class="logo"><a href="<?php echo '/wordpress' ?>"><img src="<?php echo get_theme_root_uri(); ?>/Priceless/images/logo.png" /></a></div><!--logo-->
			</header>
